...
function Hero() {
    return (
        <div className='container p-lg-5'>
            ...
            <h1 className='fs-2'>We pioneered the discount broking model in India.</h1>
            <h1 className='fs-2'>Now, we are breaking ground with our technology.</h1>
            <br/>
            </div>
            <hr/>
            <div className='row mt-5 px-lg-5 pt-lg-5 text-muted' style={{lineHeight:"1.8", fontSize:"1.1em"}}>
                <div className='col-lg-6 px-lg-5 pt-lg-5 col-sm-12'>
